...
@section('title','أنشاء مكتبة مقالات جديدة')
...
<li class="breadcrumb-item fw-bolder"><a class="nav-link d-inline" href="{{route('ArticleLibrary-dashboard.index')}}">قسم مكتبة المقالات</a></li>
    <li class="breadcrumb-item fw-bolder active " aria-current="page">أنشاء مكتبة مقالات جديدة</li>
...
<div class="card mx-1 mx-md-3 mt-3 mb-5 border-0 rounded-5 shadow-sm">
  ...
  <form class="form  mx-2 rounded-5" action="{{route('ArticleLibrary-dashboard.store')}}" method="POST">
  @csrf

  <div class="fw-bolder m-2 text-center p-3 border-bottom fs-4 text-dark border-2">أنشاء مكتبة مقالات جديدة</div>
...
<!-- 
    ...
    <form class="form  mx-2 rounded-3"  action="{{route('ArticleLibrary-dashboard.store')}}" method="POST">
        @csrf
        <h5 class="font-weight-bolder m-2 text-center p-3 border-bottom  border-2">أنشاء مكتبة مقالات جديدة</h5>
