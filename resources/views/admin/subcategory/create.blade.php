...
@section('title','أنشاء قسم فرعي جديد')
...
<li class="breadcrumb-item fw-bolder"><a class="nav-link d-inline" href="{{route('SubCategory-dashboard.index')}}">الأقسام الفرعية</a></li>
    <li class="breadcrumb-item fw-bolder active " aria-current="page">انشاء قسم فرعي جديد</li>
@endsection
...
<div class="card mx-1 mx-md-3 mt-3 mb-5 border-0 rounded-5 shadow-sm">
  ...
  <form class="form  mx-2 rounded-5" action="{{route('SubCategory-dashboard.store')}}" method="POST">
  @csrf

  <div class="fw-bolder m-2 text-center p-3 border-bottom fs-4 text-dark border-2">أنشاء قسم فرعي جديد</div>
    ...
    <div class="px-4">
        ...
        <div class="  mb-3">
            <div class=" my-3">
                ...
                <input id="title" type="text" name="title" class="form-control  rounded-4"  placeholder="مثال : اسرار في laravel" >
            </div>
        ...
        <div class="  mb-3">
            <div class=" my-3">
                ...
                <input id="slug" type="text" name="slug" class="form-control  rounded-4"  placeholder="مثال : اسرار في laravel" >
            </div>
        ...
        <div class="  mb-3">
            <div class=" my-3">
                <label for="icon" class="form-label fw-bolder text-dark">ايقونة القسم</label>
                <input id="icon" type="text" name="icon" class="form-control  rounded-4"  placeholder="مثال : fa-solid fa-house-chimney" >
            </div>
            <div id="icon_error" style="display:none;" class='bg-danger text-white m-0 p-2 fw-bolder w-100 error_msg'></div>
          </div>
...
<!-- 
    ...
    <form class="form  mx-2 rounded-3" action="{{route('SubCategory-dashboard.store')}}" method="POST" >
        @csrf
        <h5 class="font-weight-bolder m-2 text-center p-3 border-bottom  border-2">أنشاء قسم فرعي جديد</h5>
        ...
        <div class="px-4">
            ...
            <div class="  mb-5">
                <h6 class="font-weight-bolder m-2 text-end">الايقونة</h6>
                <div class="input-group input-group-outline  my-3">
                    <label class="form-label">الايقونة</label>
                    <input type="text" name="icon" class="form-control  rounded-3">
                </div>
                <div id="icon_error" style="display:none;" class='bg-danger text-white m-0 p-2 font-weight-bolder w-100 error_msg'></div>
            </div>
