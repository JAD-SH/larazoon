...
@section('title','أنشاء مكتبة اسئلة جديدة')
...
<li class="breadcrumb-item fw-bolder"><a class="nav-link d-inline" href="{{route('QuestionLibrary-dashboard.index')}}">قسم مكتبة الاسئلة</a></li>
    <li class="breadcrumb-item fw-bolder active " aria-current="page">أنشاء مكتبة اسئلة جديدة</li>
@endsection
...
<div class="card mx-1 mx-md-3 mt-3 mb-5 border-0 rounded-5 shadow-sm">
  ...
  <form class="form  mx-2 rounded-5" action="{{route('QuestionLibrary-dashboard.store')}}" method="POST">
  @csrf

  <div class="fw-bolder m-2 text-center p-3 border-bottom fs-4 text-dark border-2">أنشاء مكتبة اسئلة جديدة</div>
    ...
    <div class="px-4">
        ...
        <div class="  mb-3">
            <div class=" my-3">
                ...
                <input id="title" type="text" name="title" class="form-control  rounded-4"  placeholder="مثال : javascript" >
            </div>
        ...
        <div class="  mb-3">
            <div class=" my-3">
                ...
                <input id="slug" type="text" name="slug" class="form-control  rounded-4"  placeholder="مثال : javascript" >
            </div>
...
<!-- 
    ...
    <form class="form  mx-2 rounded-3"  action="{{route('QuestionLibrary-dashboard.store')}}" method="POST">
        @csrf
        <h5 class="font-weight-bolder m-2 text-center p-3 border-bottom  border-2">أنشاء مكتبة اسئلة جديدة</h5>
