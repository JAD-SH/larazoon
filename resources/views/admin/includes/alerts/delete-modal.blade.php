        ...
        <div class="modal-content  card p-3 shadow-sm border-0 rounded-5">
          ...
          <div class="modal-body">
            <div class="py-3 text-center">
              ...
              </i><i class="fs-1 fa fa-bell text-danger"></i>
              <div class="text-gradient fs-5 text-danger mt-4">هل تريد حذف هذا العنصر</div>
              <p class="fw-bolder mt-4">اذا قمت بحذف هذا العنصر فسيتم حذفه وإرساله الى سلة المهملات .</p>
            </div>
          </div>
          ...
          <form class="d-inline delete-form-notification"  method="POST">
                ...
                <button type="button" class="btn  rounded-3 bg-gradient-danger  mx-1 text-white ajax-submit" data-bs-dismiss="modal">موافق ,  قم بالحذف</button>
           </form>
