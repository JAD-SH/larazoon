...
@section('path')
<li class="breadcrumb-item fw-bolder"><a class="nav-link d-inline" href="{{route('SubCategory-dashboard.index')}}">قسم مكتبة الفقرات</a></li>
    <li class="breadcrumb-item fw-bolder active " aria-current="page">سلة الفقرات المحذوفة </li>
...
@section('content')
    ...
    <div class="card mx-1 mx-md-3  border-0 rounded-5  shadow-sm mt-3 mb-5 overflow-hidden">
        <h5 class="fw-bolder m-2 fs-5 text-dark text-center p-3">سلة الفقرات المحذوفة</h5>
        ...
        <table width="100%" class="table-striped col-12 w-100 table align-items-center mb-0 mx-2 rounded-4 border  border-top-0" cellspacing="0">
                ...
                <tbody class="table-group-divider text-nowrap align-middle">
                    ...
                    <tr id="item-{{$category->id}}">
                        ...
                        <td class=" text-center">
                            <div class="m-3">
                                <span class="mb-0 fw-bolder text-uppercase  fs-6 text-dark">{{$category->subcategory->title}}</span>
                            </div>
                        </td>
                        ...
                        <td class=" text-center">
                            <div class="m-3">
                                <span class="mb-0 fw-bolder">{{$category -> deleted_at->diffForHumans()}}</span>
                            </div>
                        </td>
                        ...
                        <form class="d-inline delete-form-notification" action="{{route('SubCategory-dashboard.restore',$category -> id)}}" method="POST">
                                    @csrf
                                    <button type="button" 
    ...
    @else
    <div class="fs-4 text-center p-5 font-weight-bolder">لا يوجد فقرات في سلة المهملات</div>
