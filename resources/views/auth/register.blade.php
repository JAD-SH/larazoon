  ...
  <main class="main-content">
    <div class="page-header align-items-center min-vh-100" style="background-image: url('https://images.unsplash.com/photo-1497294815431-9365093b7331?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1950&q=80');">
      ...
      <div class="container my-5">
          <div class="col-12 mx-auto card border-0 justify-content-center rounded-5 shadow-sm pb-2">
                ...
                <div class=" row ">
                  ...
                  <div class="col-lg-4 col-md-6 my-3 ">
                    ...
                    <div class="input-group input-group-outline my-3 ">
                      <input id="name" type="text" name="name" class="form-control rounded-3" value="{{ old('name') }}" required>
                    </div>
                    @error('name')
                  ...
                  <div class="col-lg-4 col-md-6 my-3">
                    ...
                    <div class="input-group input-group-outline my-3">
                      <input id="email" type="email" name="email" class="form-control rounded-3" value="{{ old('email') }}" required>
                    </div>
                    @error('email')
                      <p class='w-100 bg-danger alert text-light m-0 p-2 my-1'>
                          <strong class="fw-bolder ">{{ $message }}</strong>
                  ...
                  <div class="col-lg-4 col-md-6 my-3">
                    <label for="photo" class=" fw-bolder fs-6">الصورة (نسبة الابعاد 1/1) (اختياري) </label>
                    <div class="input-group input-group-outline my-3">
                  ...
                  <div class="col-12 my-3">
                    <div>
                        ...
                        <textarea id="description" type="textarea" name="description"class="fw-bolder form-control border p-2 my-3 rounded-3" id="exampleFormControlTextarea1" rows="3">{{ old('description') }}</textarea>
                    </div>
                    @error('description')
                      <p class='w-100 bg-danger alert text-light m-0 p-2 my-1'>
                          <strong class="fw-bolder ">{{ $message }}</strong>
