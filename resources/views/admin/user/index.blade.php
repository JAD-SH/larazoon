...
@section('path')
    ...
    <li class="breadcrumb-item fw-bolder active " aria-current="page">قسم المستخدمين</li>
@endsection
...
@if($users->count() > 0) 
    <div class="card border-0 text-center mx-1 mx-md-3 bg-none  rounded-5 py-4 d-block shadow-sm">
        ...
        <a href="{{route('User-dashboard.index')}}" class="btn bg-gradient-primary m-1 fw-bolder rounded-3 fs-6"> الجميع  </a>
    
        <a href="{{route('User-dashboard.female')}}" class="btn bg-gradient-primary m-1 fw-bolder rounded-3 fs-6"> الإناث  </a>
    
        <a href="{{route('User-dashboard.male')}}" class="btn bg-gradient-primary m-1 fw-bolder rounded-3 fs-6"> الذكور  </a>
    
        <a href="{{route('User-dashboard.top-views')}}" class="btn bg-gradient-primary m-1 fw-bolder rounded-3 fs-6"> الاكثر مشاهدة  </a>
    
        <a href="{{route('User-dashboard.top-likes')}}" class="btn bg-gradient-primary m-1 fw-bolder rounded-3 fs-6"> الاكثر اعجابا  </a>
    
        <a href="{{route('User-dashboard.blocked')}}" class="btn bg-gradient-primary m-1 fw-bolder rounded-3 fs-6"> المحظورين  </a>
    
        <a href="{{route('User-dashboard.front-end')}}" class="btn bg-gradient-primary m-1 fw-bolder rounded-3 fs-6"> Front End   </a>
    
        <a href="{{route('User-dashboard.back-end')}}" class="btn bg-gradient-primary m-1 fw-bolder rounded-3 fs-6"> Back End  </a>
    
        <a href="{{route('User-dashboard.full-stuck')}}" class="btn bg-gradient-primary m-1 fw-bolder rounded-3 fs-6"> Full Stuck  </a>
    
        <a href="{{route('User-dashboard.programming')}}" class="btn bg-gradient-primary m-1 fw-bolder rounded-3 fs-6"> Programming  </a>
        ...
        <div class="card mx-1 mx-md-3  border-0 rounded-5  shadow-sm mt-3 mb-5 overflow-hidden">
            <h5 class="fw-bolder m-2 fs-5 text-dark text-center p-3">المستخدمين</h5>
                ...
                <table width="100%" class="table-striped col-12 w-100 table align-items-center mb-0 mx-2 rounded-4 border  border-top-0" cellspacing="0">
                    <thead>
                        <tr class="text-nowrap">
                            ...
                            <th class=" text-center fw-bolder">username</th>
                            <th class=" text-center fw-bolder">اجمالي التبرع</th>
                            ...
                            <th class=" text-center fw-bolder">مواقع التواصل</th>
                            <th class=" text-center fw-bolder">الحالة</th>
                            <th class=" text-center fw-bolder">الظهور</th>
                            <th class=" text-center fw-bolder">اشعارات الموقع</th>
                    ...
                    <tbody class="table-group-divider text-nowrap align-middle">
                        ...
                        <tr  id="item-{{$user->id}}">
                            ...
                            <td class=" text-center">
                                <div class="m-3">
                                    <span class="mb-0 fw-bolder fs-6 text-dark">{{$user->username}}</span>
                                </div>
                            </td>

                            <td class=" text-center">
                                <div class="m-3">
                                    <span class="mb-0 fw-bolder fs-6 text-dark">{{$user->total_donations}}</span>
                                </div>
                            </td>
                            ...
                            <td class=" text-center">
                                <div class="m-3">
                                    ...
                                    <span class=" fw-bolder">{{$user -> getUserActive()}}</span>
                                </div>
                            </td>
                            ...
                            <td class=" text-center">
                                <div class="m-3">
                                    ...
                                    <span class=" fw-bolder">{{$user -> getStatusSiteNotification()}}</span>
                                </div>
                            </td>
    ...
    @else
        <div class="fs-4 text-center p-5 fw-bolder">لا يوجد مستخدمين بعد</div>
...
<div class="card px-0 my-5  overflow-hidden">
    <h5 class="font-weight-bolder m-2 text-center p-3">المستخدمين</h5>
    ...
    <table width="100%" id="dtHorizontalVerticalExample" class="table-striped col-12 w-100 table align-items-center mb-0 mx-2 rounded-3 border  border-top-0"  cellspacing="0">
        ...
        <thead>
            <tr >
                ...
                <th class="border-dark text-center text-uppercase font-weight-bolder">البريد الإلكتروني</th>
                <th class="border-dark text-center text-uppercase font-weight-bolder">الأهتمام</th>
                <th class="border-dark text-center text-uppercase font-weight-bolder">مواقع التواصل</th>
                <th class="border-dark text-center text-uppercase font-weight-bolder">اشعارات الموقع</th>
                <th class="border-dark text-center text-uppercase font-weight-bolder">الجنس</th>
                <th class="border-dark text-center text-uppercase font-weight-bolder">الظهور</th>
                ...
                <th class="border-dark text-center text-uppercase font-weight-bolder">اجمالي التبرع</th>
                ...
                <th class="border-dark text-center text-uppercase font-weight-bolder">تاريخ الانضمام</th>
        ...
        @foreach($users as $index=>$user)
            <tr id="item-{{$user->id}}">
                ...
                <td   class=" text-center">
                    <div class="m-3">
                        <h6 class="mb-0">{{$user->getStatusSiteNotification()}}</h6>
                    </div>
                </td>
                
                <td   class=" text-center">
                    <div class="m-3">
                        <h6 class="mb-0">{{$user->getGender()}}</h6>
                    </div>
                </td>
                
                <td   class=" text-center">
                    <div class="m-3">
                        <h6 class="mb-0">{{$user->getUserActive()}}</h6>
                    </div>
                </td>
                
                <td   class=" text-center">
                    <div class="m-3">
                        <h6 class="mb-0">{{$user->views}}</h6>
                    </div>
                </td>
                
                <td   class=" text-center">
                    <div class="m-3">
                        <h6 class="mb-0">{{$user->likes}}</h6>
                    </div>
                </td>
                
                <td   class=" text-center">
                    <div class="m-3">
                        <h6 class="mb-0">{{$user->total_donations}}</h6>
                    </div>
                </td>
                ...
                <td  class=" text-center" >
                    <div class="m-3">
                        ...
                        <a href="{{route('show-profile',$user -> id)}}" class="btn text-light btn-success  border-2 font-weight-bolder mx-1 fs-6">الملف الشخصي </a>
