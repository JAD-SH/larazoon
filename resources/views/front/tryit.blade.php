...
<html lang="en" dir="ltr">
  ...
  <head>
    ...
    <link href="{{asset('public/assets/css/tryit.css')}}" rel="stylesheet"/>
  </head>
  <body>
  <div class="con-sig">
		<span id="l-sig">{</span>
  ...
  <div class="add"></div>
    <main class="main-content  mt-0">
      <div class="col-12 text-center">
        <div class="p-0 d-inline-block">
          ...
          <button class="repeatHCJ-btn btn rounded-3 bg-gradient-info m-1" aria-label="repeat code"><i class=" fs-6 fa fa-repeat"></i></button>
          @else
          <button class="repeat-btn btn rounded-3 bg-gradient-info m-1" aria-label="repeat code"><i class=" fs-6 fa fa-repeat"></i></button>
          @endif
          <button class="btn rounded-3 bg-gradient-info m-1 run-code" aria-label="run code"><i class=" fs-6 fa fa-play"></i></button>
        </div>
      </div>
    ...
    <script>
      ...
      var myCodeMirror = CodeMirror(myTextArea, {
        ...
        mode:  "{{$tryit->type}}",
        theme: "panda-syntax",
        //readOnly: true لعدم السماح بالكتابة على المحرر
        });
        button.addEventListener('click', () => {
