<footer class="text-center footer card  p-2 py-md-4 px-md-3 border-0 rounded-5 mb-3 shadow-sm mb-2"  style="background-color: #0e0e0e !important;">
    <div class="row m-3 shadow justify-content-center align-items-center">
      <div class="col-9 col-md-3 col-xl-2  d-flex justify-content-center align-items-center mb-3 mb-md-0"><img src="{{Site()->site_logo}}" alt="" style="width:65%;"></div>
      <div class="col-12 col-md-9 col-xl-10 text-center text-md-start">
        <span class="fs-6  text-light">نقوم بنشر اشياء مهمة جدا لجميع المبرمجين على مواقع التواصل الاجتماعي ليصل الفائدة لاكبر شريحة ممكنة من المبرمجين العرب</span>
        <div class="p-2 pb-0 fw-bolder text-light d-block mt-2 site-media">
          <a class="btn m-1 shadow p-2" target="_blank" href="#">
